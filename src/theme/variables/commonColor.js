...
export default {
    ...
    // Color
    brandPrimary: platformIsIOS ? "#007aff" : "#3F51B5",
    brandInfo: "#62B1F6",
    brandSuccess: "#5cb85c",
    brandDanger: "#d9534f",
    brandWarning: "#f0ad4e",
    ...
    footerDefaultBg: platformIsIOS ? "#F8F8F8" : "#3F51B5",
    footerPaddingBottom: isIphoneX ? 34 : 0,

    // FooterTab
    tabBarTextColor: platformIsIOS ? "#737373" : "#bfc6ea",
    tabBarTextSize: platformIsIOS ? 14 : 11,
    activeTab: platformIsIOS ? "#007aff" : "#fff",
    sTabBarActiveTextColor: "#007aff",
    tabBarActiveTextColor: platformIsIOS ? "#2874F0" : "#fff",
    tabActiveBgColor: platformIsIOS ? "#cde1f9" : "#3F51B5",

    // Header
    toolbarBtnColor: platformIsIOS ? "#007aff" : "#fff",
    ...
    toolbarTextColor: platformIsIOS ? "#000" : "#fff",
    iosStatusbar: "dark-content",
    toolbarDefaultBorder: platformIsIOS ? "#a7a6ab" : "#3F51B5",
    get statusBarColor() {
    ...
    subtitleColor: platformIsIOS ? "#000" : "#fff",
